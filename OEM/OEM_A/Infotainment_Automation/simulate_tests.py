"""
simulate_tests.py  –  Virtual Bench Simulation for Infotainment Automation
=====================================================================
...
What it does
------------
1. Scans every .can file under Infotainment_Automation for testcase definitions.
...
Usage
-----
    python simulate_tests.py [--root <Infotainment_Automation folder>]
    ...
    for tg_title, tc_name, _ in cases:
        ...
        if tc_name not in defined:
            ...
            err.text = (
                ...
                "in any .can file under Infotainment_Automation."
            )
        else:
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Virtual bench simulation for Infotainment Automation. "
    ...
    summary_lines: List[str] = [
        "Infotainment Automation – Virtual Bench Simulation Summary",
        "=" * 56,
