"""
email_report.py  –  Send the Infotainment consolidated test report via e-mail
========================================================================
...
---------------------
  ...
  EMAIL_FROM_NAME      Friendly display name          (default: Infotainment Automation)
...
def _build_message(
    ...
    from_name = os.environ.get("EMAIL_FROM_NAME", "Infotainment Automation")
...
<body>
  <h2>Infotainment Automation – Test Report</h2>
  <table>
  ...
  <p style="font-size:0.85em; color:#888;">
    Sent by <em>email_report.py</em> – Infotainment Automation pipeline.
  </p>
</body>
</html>
"""
...
def send_report(
    ...
    run_label = f"#{build_number}" if build_number else "local"
    auto_subject = (
        f"Infotainment Automation – Test Report {run_label}"
...
def _parse_args(argv: Optional[list] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Send the Infotainment consolidated test report via e-mail.",
...
file next to this script, or Jenkins node/pipeline settings):
  ...
  EMAIL_FROM_NAME      Friendly sender name   (default: Infotainment Automation)
