...
====================================================================
Scans all .can/.cin files under Infotainment_Automation and reports issues
...
Usage
-----
    python validate_capl.py [--root <Infotainment_Automation folder>]
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Pre-deployment CAPL syntax consistency checker for Infotainment Automation"
    )
    parser.add_argument(
        '--root',
        type=Path,
