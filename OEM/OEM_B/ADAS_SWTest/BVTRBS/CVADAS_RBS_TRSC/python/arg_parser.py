...
# Search for the Jenkins config folder dynamically
jenkins_paths = glob.glob(r"C:\JS\workspace\**\config\Jenkins", recursive=True)

# If no paths were found, dynamically search for the SWTest_HD_CPU_Load_Optimizations folder
if not jenkins_paths:
    workspace_base = r"C:\JS\workspace"
    ...
    if swtest_folders:
        ...
        jenkins_paths = [fallback_path]
    else:
        logging.warning("No SWTest-related folder found in workspace. Jenkins paths will be empty.")
