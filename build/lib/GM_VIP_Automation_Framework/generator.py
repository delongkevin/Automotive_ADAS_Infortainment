...
def generate_session_script(
    ...
    lines = [
        ...
        "# a 'GM_VIP_Automation_Framework/__init__.py' package, then add it to",
        "# sys.path so that 'import GM_VIP_Automation_Framework' works regardless",
        "# of where this script was placed.",
        "_here = Path(__file__).resolve().parent",
        "_fw_parent = _here",
        "while _fw_parent != _fw_parent.parent:",
        "    if (_fw_parent / 'GM_VIP_Automation_Framework' / '__init__.py').is_file():",
        "        break",
        "    _fw_parent = _fw_parent.parent",
        "else:",
        "    raise RuntimeError(",
        "        f'GM_VIP_Automation_Framework package not found searching upward from {_here}.'",
