"""
Automation Framework – Graphical User Interface
=======================================================
...
Or via the package entry point (once installed with ``pip install -e .``)::
    ...
    python -m Automation_Framework.gui
...
# ---------------------------------------------------------------------------
from Automation_Framework.main import (
...
class AutomationGui(tk.Tk):
    """Root window for the Automation Framework GUI."""
    ...
    def _save_log(self) -> None:
        path = filedialog.asksaveasfilename(
            ...
            initialfile=f"automation_log_{time.strftime('%Y%m%d_%H%M%S')}.txt",
        )
        if path:
            text = self._log.get("1.0", tk.END)
    ...
    def _open_t32(self) -> None:
        ...
        from Automation_Framework.utils.exceptions import T32LaunchError
    ...
    def _py_suite_template(name: str) -> str:
        ...
        return (
            '"""\n'
            f'{name} – Automation Framework test suite\n'
    ...
    def _json_suite_template(name: str) -> dict:
        ...
        return {
            "_comment": f"Automation Framework – {name} test cases",
    ...
    def _show_about(self) -> None:
        messagebox.showinfo(
            "About Automation Framework GUI",
