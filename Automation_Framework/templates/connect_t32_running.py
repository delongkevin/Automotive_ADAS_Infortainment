...
# ---------------------------------------------------------------------------
# Bootstrap: make Automation_Framework importable from any working
...
#   parent.parent                     →  Automation_Framework/
...
from Automation_Framework import runner  # noqa: E402

# ---------------------------------------------------------------------------
# Paths – config.json and test_cases.json live in the Automation_Framework
