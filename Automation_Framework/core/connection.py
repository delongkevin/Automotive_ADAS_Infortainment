"""
Automation Framework – Trace32 Connection Manager
=========================================================
...
def auto_detect_t32(
    ...
    search_dirs:
        ...
        :attr:`~Automation_Framework.config.T32Settings.t32_search_dirs`.
    exe_names:
        Executable file names to look for.  Defaults to
        :attr:`~Automation_Framework.config.T32Settings.t32_exe_names`.
