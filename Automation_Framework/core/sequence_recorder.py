"""
Automation Framework – Execution Sequence Recorder
==========================================================
...
1. A ``*_test_cases.json`` file that the existing
   :func:`~Automation_Framework.runner.run_from_json` engine can
...
::
    ...
    from Automation_Framework.core.sequence_recorder import SequenceRecorder
...
class SequenceRecorder:
    ...
    def export_test_cases_json(
        ...
        :func:`~Automation_Framework.runner.run_from_json` engine.
    ...
    def export_python_script(
        ...
        uses the ``Automation_Framework`` public API so it works in
    ...
    def _events_to_python_script(self) -> str:
        ...
        lines: List[str] = [
            ...
            "from Automation_Framework.core.capl_monitor import CAPLTestMonitor",
            "from Automation_Framework.core import debugger as _dbg",
            "",
            "",
