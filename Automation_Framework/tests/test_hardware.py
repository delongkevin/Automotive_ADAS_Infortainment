...
Tests for the hardware interface modules:
  - Automation_Framework.core.can_bus   (CANBusClient mock mode)
  - Automation_Framework.core.canoe     (CANoeClient mock mode)
  - Automation_Framework.core.power_supply (BKPrecision1687B mock mode)
...
class TestCANBusClientMock(unittest.TestCase):
    ...
    def _client(self):
        from Automation_Framework.core.can_bus import CANBusClient
    ...
    def test_error_raised_without_pycan_in_live_mode(self):
        from Automation_Framework.core.can_bus import CANBusClient, CANBusError
        # Temporarily remove python-can from sys.modules if it exists.
        import Automation_Framework.core.can_bus as _mod
...
class TestCANoeClientMock(unittest.TestCase):
    ...
    def _client(self):
        from Automation_Framework.core.canoe import CANoeClient
    ...
    def test_error_raised_without_win32_in_live_mode(self):
        from Automation_Framework.core.canoe import CANoeClient, CANoeError
        import Automation_Framework.core.canoe as _mod
...
class TestBKPrecision1687BMock(unittest.TestCase):
    ...
    def _psu(self, port="COM4"):
        from Automation_Framework.core.power_supply import BKPrecision1687B
    ...
    def test_error_raised_without_pyserial_in_live_mode(self):
        from Automation_Framework.core.power_supply import (
            BKPrecision1687B, PowerSupplyError,
        )
        import Automation_Framework.core.power_supply as _mod
    ...
    def test_output_on_settle_delay(self):
        ...
        with patch("Automation_Framework.core.power_supply.time") as mock_time:
            psu.output_on()
