"""
Tests for Automation_Framework.core.sequence_recorder
...
from Automation_Framework.core.sequence_recorder import (  # noqa: E402
    ExecutionEvent,
    SequenceRecorder,
)
...
class TestSequenceRecorderPythonExport(unittest.TestCase):
    ...
    def test_export_python_script_contains_framework_import(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with open(path, encoding="utf-8") as fh:
                content = fh.read()
        self.assertIn("Automation_Framework", content)
