...
_log = logging.getLogger("automation_t32.test_sanity")
...
#
# Layout:  <repo_root>/Automation_Framework/tests/test_sanity.py
# We need <repo_root> on sys.path so that
#   "import Automation_Framework"  resolves correctly.
# ---------------------------------------------------------------------------
...
import Automation_Framework.core.breakpoints as _bp  # noqa: E402
import Automation_Framework.core.variables as _var   # noqa: E402
import Automation_Framework.core.debugger as _dbg   # noqa: E402

if USE_LIVE_T32:
    # LIVE MODE – connect to the already-open Trace32 application once,
    # then share that single connection across all test cases.
    from Automation_Framework.core.connection import T32Connection as _T32Conn
...
if USE_LIVE_T32 and USE_CANOE:
    from Automation_Framework.core.canoe import CANoeClient as _CANoeClient
...
if USE_LIVE_T32 and USE_CAN_BUS and not USE_CANOE:
    from Automation_Framework.core.can_bus import CANBusClient as _CANBusClient
...
if USE_LIVE_T32 and USE_POWER_SUPPLY:
    from Automation_Framework.core.power_supply import BKPrecision1687B as _BKP
