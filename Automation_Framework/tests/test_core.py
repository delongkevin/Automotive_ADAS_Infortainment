"""
Tests for Automation_Framework core modules.
...
class TestConnection(unittest.TestCase):
    ...
    def test_auto_detect_no_dirs_raises(self):
        from Automation_Framework.core.connection import auto_detect_t32
        from Automation_Framework.utils.exceptions import T32AutoDetectError
    ...
    def test_parse_config_port(self):
        from Automation_Framework.core.connection import parse_config_port
        import tempfile, os
...
class TestDebugger(unittest.TestCase):
    ...
    def setUp(self):
        from Automation_Framework.core import debugger as dbg
        self.dbg = dbg
    ...
    def test_go_waits_before_go_when_in_reset(self):
        ...
        import Automation_Framework.core.debugger as _dbg_mod
        ...
        try:
            with patch("Automation_Framework.core.debugger.time") as mock_time:
    ...
    def test_no_default_connection_raises(self):
        from Automation_Framework.core.debugger import _conn
        from Automation_Framework.utils.exceptions import T32ConnectionError
        import Automation_Framework.core.debugger as dbg
    ...
    def test_get_ecu_state_running(self):
        ...
        from Automation_Framework.core.debugger import ECUState
        conn = _make_conn(running=True)
...
class TestBreakpoints(unittest.TestCase):
    ...
    def test_set_breakpoint_success(self):
        from Automation_Framework.core import breakpoints as bp
        conn = _make_conn(running=False)
    ...
    def test_set_breakpoint_retries_on_exception(self):
        from Automation_Framework.core import breakpoints as bp
        from Automation_Framework.utils.exceptions import T32BreakpointError
        conn = _make_conn(running=False)
        call_count = [0]
    ...
    def test_check_halted_at_timeout_raises(self):
        from Automation_Framework.core import breakpoints as bp
        from Automation_Framework.utils.exceptions import T32BreakpointNotReachedError
...
class TestVariables(unittest.TestCase):
    ...
    def test_read_variable(self):
        from Automation_Framework.core import variables as var
        conn = _make_conn(running=False)
    ...
    def test_check_variable_fail_raises(self):
        from Automation_Framework.core import variables as var
        from Automation_Framework.utils.exceptions import T32VariableError
        conn = _make_conn(running=False)
    ...
    def test_check_variable_until_timeout_raises(self):
        from Automation_Framework.core import variables as var
        from Automation_Framework.utils.exceptions import T32TimeoutError
        conn = _make_conn(running=False)
...
class TestRegisters(unittest.TestCase):
    ...
    def test_read_register(self):
        from Automation_Framework.core import registers as reg
        conn = _make_conn(running=False)
    ...
    def test_check_register_fail_raises(self):
        from Automation_Framework.core import registers as reg
        from Automation_Framework.utils.exceptions import T32RegisterError
        conn = _make_conn(running=False)
...
class TestSymbols(unittest.TestCase):
    ...
    def test_symbol_exists_true(self):
        from Automation_Framework.core import symbols as sym
        conn = _make_conn(running=False)
    ...
    def test_get_symbol_address_not_found_raises(self):
        from Automation_Framework.core import symbols as sym
        from Automation_Framework.utils.exceptions import T32SymbolError
        conn = _make_conn(running=False)
        # side_effect takes priority over return_value, so clear it first.
        conn.fnc.side_effect = None
        conn.fnc.return_value = "FALSE()"
...
class TestSynchronization(unittest.TestCase):
    ...
    def test_new_settings_have_correct_defaults(self):
        ...
        from Automation_Framework.config import T32Settings
        fresh = T32Settings()
...
class TestRunnerGoBeforeCheck(unittest.TestCase):
    ...
    def test_go_before_check_issues_go_then_reads_variable(self):
        ...
        from Automation_Framework import runner, config
        ...
        from Automation_Framework.report import TestCaseReport
