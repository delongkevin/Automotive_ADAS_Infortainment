"""
Tests for Automation_Framework.core.symbol_discovery
============================================================
...
_FW_DIR    = os.path.abspath(os.path.join(_HERE, ".."))          # Automation_Framework/
...
if USE_LIVE_T32:
    ...
    from Automation_Framework.core.symbol_discovery import discover_symbols
    ...
    if DISCOVER_BREAKPOINT:
        from Automation_Framework.core import breakpoints as _bp_mod
...
class TestSymbolKind(unittest.TestCase):
    ...
    def test_values(self):
        from Automation_Framework.core.symbol_discovery import SymbolKind
...
class TestParseSymbolList(unittest.TestCase):
    ...
    def setUp(self):
        from Automation_Framework.core import symbol_discovery as sd
        self.sd = sd
...
class TestSymbolInventory(unittest.TestCase):
    ...
    def test_empty_inventory(self):
        from Automation_Framework.core.symbol_discovery import SymbolInventory
        inv = SymbolInventory()
...
class TestDiscoverSymbols(unittest.TestCase):
    ...
    def test_discover_modules_helper(self):
        from Automation_Framework.core.symbol_discovery import discover_modules
        conn = _make_conn()
...
class TestPublicExports(unittest.TestCase):
    ...
    def test_top_level_imports(self):
        import Automation_Framework as fw
