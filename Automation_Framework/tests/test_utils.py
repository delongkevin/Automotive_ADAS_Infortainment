"""
Tests for Automation_Framework.utils module.
...
class TestExceptions(unittest.TestCase):
    ...
    def test_exception_hierarchy(self):
        from Automation_Framework.utils.exceptions import (
            T32FrameworkError,
            T32ConnectionError,
            T32TimeoutError,
            T32CommandError,
    ...
    def test_command_error_message(self):
        from Automation_Framework.utils.exceptions import T32CommandError
...
class TestLogger(unittest.TestCase):
    ...
    def test_configure_logger_no_duplicate_handlers(self):
        from Automation_Framework.utils.logger import configure_logger, _LOGGER_NAME
        import logging
...
class TestRetry(unittest.TestCase):
    ...
    def test_retry_succeeds_on_first_attempt(self):
        from Automation_Framework.utils.retry import retry
        call_count = [0]
    ...
    def test_poll_until_true_immediately(self):
        from Automation_Framework.utils.retry import poll_until
